...
<!DOCTYPE html>
        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    <span class="name"><?php echo $_SESSION['guidance_name']?></span>
                    <span class="profession">Guidance</span>
                </div>
            </div>
    ...
    <section class="home">
            ...
            <div class = "home4" id = "idHome4" style= "display:none; width: 50%; margin-left: 25%; margin-top: 20%;">
            <div class="input-group mb-3">
                <input type="file" class="form-control" id="inputGroupFile02">
                <label class="input-group-text" for="inputGroupFile02">Upload PDF File</label>
                </div>
            </div>
