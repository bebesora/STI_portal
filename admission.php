...
<!DOCTYPE html>
        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    <span class="name"><?php echo $_SESSION['admission_name']?></span>
                    <span class="profession">Admission</span>
                </div>
            </div>
    ...
    <section class="home">
            ...
            <div class = "home3" id = "idHome3" style= "display:none; width: 50%; margin-left: 25%; margin-top: 20%;">
